...
import { getHeight, getWidth, normalizeIcon, setHeight, setOuterHeight, setOuterWidth, setWidth } from '../_utilities/utilities.js';
...
class Resizable extends Base {
  ...
  _init(options) {
    ...
    let thisAspectRatio;
    let mx,
      my = 0; // position of this element, and mouse x, y coordinate
